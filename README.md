...
![Stack](https://img.shields.io/badge/stack-MySQL%20%7C%20Power%20BI%20%7C%20Python-informational)
...
**Industria:** Distribución mayorista de modelos y coleccionables a escala (clásicos, motos, coches, aviones, barcos).
**Necesidad:** Migración del sistema legacy al ERP Cloud de TheBigTech y construcción de un dashboard ejecutivo en Power BI con los KPIs principales del negocio.
